...
export const SwitchThumb = styled(Animated.View)<SwitchThumbProps>(
    ({ height, width, padding, backgroundColor, theme: { palette: p } }) => ({
        height: height ?? 24,
        width: width ?? 38,
        padding: padding ?? 5,
...
export const SwitchTrack = styled(Animated.View)<SwitchTrackStyle>(
