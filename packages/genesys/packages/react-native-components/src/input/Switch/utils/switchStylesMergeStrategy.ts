...
export default function (
    ...
    const invalidFinalTrackStyle = {
        ...defaultInvalidTrackStyle,
        ...globalInvalidTrackStyle,
        ...invalidTrackStyle,
    };
    const validFinalTrackStyle = {
        ...defaultValidTrackStyle,
        ...globalValidTrackStyle,
        ...validTrackStyle,
    };
    const disabledFinalTrackStyle = {
        ...defaultDisabledTrackStyle,
        ...globalDisabledTrackStyle,
        ...disabledTrackStyle,
    };
    const focusedFinalTrackStyle = {
        ...defaultFocusedTrackStyle,
        ...globalFocusedTrackStyle,
        ...focusedTrackStyle,
    };
    const readonlyFinalTrackStyle = {
        ...defaultReadonlyTrackStyle,
        ...globalReadonlyTrackStyle,
        ...readonlyTrackStyle,
    };
    const requiredFinalTrackStyle = {
        ...defaultRequiredTrackStyle,
        ...globalRequiredTrackStyle,
        ...requiredTrackStyle,
    };

    const finalThumbStyle = { ...defaultThumbStyle, ...globalThumbStyle, ...thumbStyle };
    const invalidFinalThumbStyle = {
        ...defaultInvalidThumbStyle,
        ...globalInvalidThumbStyle,
        ...invalidThumbStyle,
    };
    const validFinalThumbStyle = {
        ...defaultValidThumbStyle,
        ...globalValidThumbStyle,
        ...validThumbStyle,
    };
    const disabledFinalThumbStyle = {
        ...defaultDisabledThumbStyle,
        ...globalDisabledThumbStyle,
        ...disabledThumbStyle,
    };
    const focusedFinalThumbStyle = {
        ...defaultFocusedThumbStyle,
        ...globalFocusedThumbStyle,
        ...focusedThumbStyle,
    };
    const readonlyFinalThumbStyle = {
        ...defaultReadonlyThumbStyle,
        ...globalReadonlyThumbStyle,
        ...readonlyThumbStyle,
    };
    const requiredFinalThumbStyle = {
        ...defaultRequiredThumbStyle,
        ...globalRequiredThumbStyle,
        ...requiredThumbStyle,
    };
