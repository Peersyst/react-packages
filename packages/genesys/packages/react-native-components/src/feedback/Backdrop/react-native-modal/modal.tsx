...
export class ReactNativeModal extends Component<ModalProps, State> {
    static propTypes = {
    ...
    shouldPropagateSwipe = (evt: GestureResponderEvent, gestureState: PanResponderGestureState) => {
        ...
        switch (this.currentSwipingDirection) {
            case "down":
                return (
                    ...
                    ((this.props.deviceHeight || this.state.deviceHeight) - gestureState.y0)
                );
            case "up":
    ...
    makeBackdrop = () => {
        ...
        if (this.props.customBackdrop && !isValidElement(this.props.customBackdrop)) {
            console.warn(
        ...
        const backdropComputedStyle = [
            {
                ...
                backgroundColor:
                    this.state.showContent && !hasCustomBackdrop ? backdropColor : "transparent",
            },
        ];
