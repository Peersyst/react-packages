// From https://github.com/pmndrs/its-fine/blob/main/src/index.tsx
// Includes some fixes

// WARNING: This may break in the future if React changes its internal implementation

// We can remove it if react-native ever has a portal that forwards contexts

// Will be used mainly to forward contexts when using Portals
