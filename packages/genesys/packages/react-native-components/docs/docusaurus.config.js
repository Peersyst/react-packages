...
const config = {
    ...
    baseUrl: "/react-native-components-docs",

    // GitHub pages deployment config.
    // If you aren't using GitHub pages, you don't need these.
    organizationName: "Peersyst", // Usually your GitHub org/user name.
    projectName: "react-native-components-docs", // Usually your repo name.
    trailingSlash: false,
    ...
    themeConfig:
        ...
        ({
            ...
            navbar: {
                title: "React Native Components",
                logo: {
                    alt: "React Native Components Logo",
                    src: "img/logo.svg",
                },
                items: [
                    {
                    ...
                    {
                        href: "https://github.com/Peersyst/react-packages/tree/main/packages/genesys/packages/react-native-components",
                        label: "GitHub",
                        position: "right",
                    },
                ],
