    ...
    constructor(
        ...
        if (!message) {
            if (options.greaterThan !== undefined) {
                this.message = translate("invalid_number_gt", {
                    n: options.greaterThan.toString(),
                });
            }
            if (options.greaterEqualThan !== undefined) {
                this.message = translate("invalid_number_gte", {
            ...
            if (options.lowerEqualThan !== undefined) {
                this.message = translate("invalid_number_lte", {
