...
export function Slider({
    ...
    return (
        <SliderRoot {...styleProps} className={cx(className, "Slider", disabled && "Disabled")} style={fsx(style, styleProps)}>
            <SliderRail className={cx(railClassName, "SliderRail", disabled && "Disabled")} style={fsx(railStyle, styleProps)} />
            <SliderTrack
