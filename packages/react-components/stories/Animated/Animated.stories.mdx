...
````
<Canvas>
    <AnimatedDisplay Animation="Fade"><DisplayText>🚀</DisplayText></AnimatedDisplay>
</Canvas>
...
<Canvas>
    <Grid cols={2} colGap={40} rowGap={40} breakpoints={[{maxWidth: 1100, cols: 1}]}>
        <AnimatedDisplay Animation="Fade"><DisplayText>Fade</DisplayText></AnimatedDisplay>
        <AnimatedDisplay Animation="Slide" direction="left"><DisplayText>Slide</DisplayText></AnimatedDisplay>
        <AnimatedDisplay Animation="FadingSlide" direction="down"><DisplayText>FadingSlide</DisplayText></AnimatedDisplay>
        <AnimatedDisplay Animation="Scale"><DisplayText>Scale</DisplayText></AnimatedDisplay>
        <AnimatedDisplay Animation="FadingScale"><DisplayText>FadingScale</DisplayText></AnimatedDisplay>
    </Grid>
</Canvas>
