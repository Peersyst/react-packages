...
<Canvas>
    ...
    >
        ...
        >
            ...
            <TextField label="Error label" placeholder="Write something..." value="Validate number" validators={{number: true}} />
            <TextField label="Success label" placeholder="Write something..." value="Show valid" showValid />
            <TextField label="Normal label" placeholder="Write something..." type="password" />
